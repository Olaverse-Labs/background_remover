...
def process_background_removal(image: Image.Image, mode: str, response_type: str, background=None):
    """Helper function to process background removal and return appropriate response"""
...
@app.post("/remove-background/file")
